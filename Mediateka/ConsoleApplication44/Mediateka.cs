...
namespace ConsoleApplication44
{
    public class Mediateka : ICollection<IMediaItem>
    {
        ...
        internal void SortByRating()
        {
            this.Sort(new MediaItemComparerByReting());
        }

       /* internal void SortByIntervalCreationDate()
        {
            this.Sort(new MediaItemSortByIntervalCreationDate());
        }*/
    }
}
