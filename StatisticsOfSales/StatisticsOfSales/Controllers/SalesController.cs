...
using StatisticsOfSales.Models;
using StatisticsOfSales.DAL;

namespace StatisticsOfSales.Controllers
{
    public class SalesController : Controller
    {
        public StatisticsOfSalesDataEntities_v2 db = new StatisticsOfSalesDataEntities_v2();
